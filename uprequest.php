      ...
      <div id="content">
        ...
        <form class="user" method="post" action="includes/user.php">
          ...
          <div class="row">
            ...
            <div class="col-6 mb-3">
              <input type="text" class="form-control form-control-user" id="device_name" name="device name" placeholder="Epson projector" required>
            </div>
          </div>
          <br>
          ...
          <div class="row">
            ...
            <div class="col-6 mb-3"> <input type="text" class="form-control form-control-user" id="device_description" name="description" placeholder="Request of New Air condition" required></div>
          </div>
          <br>
